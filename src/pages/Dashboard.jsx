...
export default function Dashboard() {
  ...
  const [stats,       setStats]       = useState({ employees:0, pendingVac:0, pendingUsers:0 })
  ...
  const fetchAll = useCallback(async () => {
    ...
    try {
      ...
      if (canManage) {
        const [empCount, vacPending, usersPending, todayShiftRes, allEmps] = await Promise.all([
        ...
        setStats({ employees: empCount.count||0, pendingVac: vacPending.count||0, pendingUsers: usersPending.count||0 })
